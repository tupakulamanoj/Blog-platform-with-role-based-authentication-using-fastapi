...
'use server';
/**
 * @fileOverview A flow that suggests relevant tags for a blog post based on its content.
 *
...
const suggestTagsPrompt = ai.definePrompt({
  ...
  prompt: `You are a blog post tagging expert.

  Given the content of a blog post, you will suggest a list of relevant tags that can be used to categorize the post and improve its discoverability.
